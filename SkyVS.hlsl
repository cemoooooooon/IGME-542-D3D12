...
{
    uint vertexShaderBufferIndex;
    uint vertexShaderConstantBuffer;
    uint pixelShaderSkybox;
}
...
{
    ConstantBuffer<PerFrameData> cb = ResourceDescriptorHeap[vertexShaderConstantBuffer];
    StructuredBuffer<Vertex> vb = ResourceDescriptorHeap[vertexShaderBufferIndex];
